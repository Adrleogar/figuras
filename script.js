...
const nombreDelEquipoDeLaboratorio = "HUNGRIA";
...
// Si el emparejamiento es correcto, se visualiza modicando el estilo del patrón y
...
function dragOver(e) {
  ...
  // Si la figura se mantiene dentro del paneñ del patrón sin soltarla, no es necesario 
  // hacer ningún cambio. 
  e.preventDefault();
  return false;
}
...
function dragLeave(e) {
  ...
  // El efecto visual se consigue eliminando del panelPatrón el estilo de clase figura--arrastrando 
...
//  Devuelve un elemento arbitraio del array
